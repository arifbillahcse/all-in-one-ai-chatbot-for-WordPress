	...
	public static function fields(): array {
		...
		$fields += array(
			...
			'crm_require_consent'   => array(
				...
				'section' => 'crm',
				'type'    => 'checkbox',
				'label'   => __( 'Consent', 'all-in-one-ai-chatbot' ),
			...
			'crm_country_code'      => array(
				...
				'section'     => 'crm',
				'type'        => 'text',
				'label'       => __( 'Default country code', 'all-in-one-ai-chatbot' ),
				'desc'        => __( 'Added to phone numbers typed without one, e.g. 880 for Bangladesh (01711… becomes +8801711…).', 'all-in-one-ai-chatbot' ),
				'placeholder' => '880',
				'default'     => '880',
				'max'         => 4,
			),
			...
			'hubspot_key'           => array(
				...
				'section' => 'hubspot',
				'type'    => 'secret',
				'label'   => __( 'Access token', 'all-in-one-ai-chatbot' ),
				'default' => '',
				'test'    => 'hubspot',
			),
			'hubspot_lifecycle'     => array(
				...
				'section' => 'hubspot',
				'type'    => 'select',
				'label'   => __( 'Lifecycle stage for new contacts', 'all-in-one-ai-chatbot' ),
				'desc'    => __( 'Existing contacts keep their stage.', 'all-in-one-ai-chatbot' ),
				'options' => array(
					'subscriber'             => __( 'Subscriber', 'all-in-one-ai-chatbot' ),
					'lead'                   => __( 'Lead', 'all-in-one-ai-chatbot' ),
					'marketingqualifiedlead' => __( 'Marketing qualified lead', 'all-in-one-ai-chatbot' ),
					'salesqualifiedlead'     => __( 'Sales qualified lead', 'all-in-one-ai-chatbot' ),
					'opportunity'            => __( 'Opportunity', 'all-in-one-ai-chatbot' ),
				),
				'default' => 'lead',
			),
			'hubspot_note'          => array(
				...
				'section' => 'hubspot',
				'type'    => 'checkbox',
				'label'   => __( 'Chat as a note', 'all-in-one-ai-chatbot' ),
			...
			'mailchimp_list'        => array(
				...
				'section'     => 'mailchimp',
				'type'        => 'text',
				'label'       => __( 'Audience ID', 'all-in-one-ai-chatbot' ),
				'desc'        => __( 'Press "Test connection" to list your audiences (filled in automatically if you have one).', 'all-in-one-ai-chatbot' ),
			...
			'mailchimp_status'      => array(
				...
				'section' => 'mailchimp',
				'type'    => 'select',
				'label'   => __( 'New contacts are', 'all-in-one-ai-chatbot' ),
				'options' => array(
					'pending'       => __( 'Asked to confirm by email (double opt-in, recommended)', 'all-in-one-ai-chatbot' ),
					'subscribed'    => __( 'Subscribed (only if they agreed to marketing emails)', 'all-in-one-ai-chatbot' ),
					'transactional' => __( 'Contacts only, not subscribed', 'all-in-one-ai-chatbot' ),
				),
				'default' => 'pending',
			),
			'mailchimp_tags'        => array(
				...
				'section' => 'mailchimp',
				'type'    => 'text',
				'label'   => __( 'Tags', 'all-in-one-ai-chatbot' ),
				'desc'    => __( 'Comma separated.', 'all-in-one-ai-chatbot' ),
				'default' => 'AI Chatbot',
				'max'     => 200,
			),
			...
			'brevo_lists'           => array(
				...
				'section'     => 'brevo',
				'type'        => 'text',
				'label'       => __( 'List IDs', 'all-in-one-ai-chatbot' ),
				'desc'        => __( 'The number shown next to each list in Brevo → Contacts → Lists. Several separated by commas.', 'all-in-one-ai-chatbot' ),
				'placeholder' => '2, 7',
				'default'     => '',
				'max'         => 100,
			),
