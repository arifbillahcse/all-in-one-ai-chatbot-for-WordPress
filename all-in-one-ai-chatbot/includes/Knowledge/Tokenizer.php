...
final class Tokenizer {
	...
	private const STOPWORDS = array(
		...
		'which', 'who', 'why', 'will', 'with', 'would', 'you', 'your', 'please', 'hi', 'hello',
		'about', 'any', 'get', 'tell', 'want', 'need', 'know',
		// Bangla.
		'এবং', 'ও', 'কি', 'কী', 'আমি', 'আমার', 'আমাদের', 'আপনি', 'আপনার', 'এই', 'সেই', 'যে', 'না',
		'হয়', 'হয়', 'করে', 'করা', 'এর', 'জন্য', 'থেকে', 'একটি', 'কিছু', 'আছে', 'দিয়ে', 'দিয়ে',
		'তা', 'তার', 'কেন', 'কোন', 'কোথায়', 'কোথায়',
	);
