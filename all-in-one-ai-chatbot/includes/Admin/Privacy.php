...
final class Privacy {
	...
	public static function policy_text(): void {
		...
		$text = '<p>' . esc_html__( 'This website uses an AI chat assistant. When you use it, the messages you type, and the address of the page you are on, are stored on this website and sent to our AI provider (OpenAI, Anthropic or DeepSeek, depending on configuration) to generate a reply. Please do not share passwords, payment card details or other sensitive information in the chat.', 'all-in-one-ai-chatbot' ) . '</p>'
